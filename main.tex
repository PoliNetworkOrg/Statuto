...
\section{Sede}
\begin{enumerate}
 \item L’associazione studentesca ha sede legale all'interno del comune di Milano.
...
\vspace{-5pt}
\begin{enumerate}
 \item organizza e gestisce eventi formativi e culturali e di aggregazione;
 \item promuove la comunicazione fra studenti del Politecnico di Milano al fine di realizzare progetti di interesse generale;
 \item Non ha scopo di lucro ed opera in ambito universitario;
 \item È libera da ogni condizionamento politico, economico e religioso;
...
\begin{enumerate}
 ...
 \item Nel caso non pervenga alcuna risposta la richiesta è da considerarsi respinta. La delibera di rigetto della domanda di ammissione dovrà essere motivata all’Assemblea dei Soci e all'aspirante Socio, entro ulteriori 90 (novanta) giorni. L'aspirante socio può chiedere all'Assemblea di riesaminare la decisione, la quale si esprime definitivamente entro i successivi 180 (centoottanta) giorni.
 \item All’atto dell’accettazione della richiesta da parte dell’associazione il Segretario dovrà comunicare al richiedente la decisione. Il richiedente dovrà versare la quota associativa e successivamente acquisirà ad ogni effetto la qualifica di Socio con obbligo per il Segretario di annotarlo nel registro dei soci entro sette giorni dal pagamento.
...
\begin{enumerate}
 ...
 \begin{enumerate}
  ...
  \item ratifica, quando richiesto da almeno un socio, quelli proposti dal Direttivo;
  \item delibera sull’esclusione dei Soci.
  \item su ogni altra materia per la quale la normativa vigente richiede la deliberazione di un'assemblea ordinaria.
 \end{enumerate}
 \item L'Assemblea straordinaria:
 \vspace{-5pt}
 \begin{enumerate}
  \item delibera sulle modifiche dello Statuto dell’organizzazione propiste dal Direttivo o dagli associati in un numero non inferiore al terzo degli iscritti;
  \item delibera lo scioglimento con conseguente liquidazione nonché devoluzione del patrimonio;
  \item delibera sulla fusione, trasformazione dell'Associazione;
  \item su ogni altra materia per la quale la normativa vigente richiede la deliberazione di un'assemblea straordinaria.
 \end{enumerate}
 ...
 \item L’Assemblea ordinaria delibera a maggioranza dei voti dei presenti, in caso di parità prevale il voto del Presidente.
 \item L'Assemblea straordinaria delibera a maggioranza assoluta dei voti dei presenti. In caso di parità la proposta è respinta.
 \item Gli Associati possono farsi rappresentare in Assemblea solo da altri Associati, conferendo delega scritta tramite canale di contatto. Ciascun Associato è portatore di al più una delega. La delega, come previsto nel terzo comma precedente non è ammessa in sede di prima convocazione di un'assemblea straordinaria. Non è possibile delegare membri del Direttivo.
...
\item predispone il bilancio di esercizio e, se previsto, il bilancio sociale, li sottopone all’approvazione dell’Assemblea e cura gli ulteriori adempimenti previsti dalla legge, predispone tutti gli elementi utili all’Assemblea per la previsione e la programmazione economica dell’esercizio;
...
\item redige i regolamenti interni sottponendoli alla ratifica dell'assemblea.
\end{enumerate}
\item Il mandato dura tre anni e non è prorogabile.
\item Sono eletti nel Consiglio Direttivo i candidati che hanno ottenuto il maggior numero di voti fino all’esaurimento dei seggi da assegnare.
\item Per l’assegnazione delle cariche Sociali si procede come di seguito:
\begin{enumerate}
   \item Ogni candidato, contestualmente alla presentazione della candidatura, può dichiarare due cariche Sociali che vorrebbe ricoprire in ordine di preferenza;
   \item Agli eletti viene assegnata la carica per la quale si sono proposti. L’ordine di elezione alla carica di membro del Direttivo determina la priorità sulla carica indicata (a titolo esemplificativo: se sia il primo degli eletti che il quarto degli eletti si sono proposti per la carica di Presidente essa è attribuita al primo degli eletti). In caso di parità di voti prevale il più giovane.
   \item Qualora, dopo la ridistribuzione, vi siano cariche Sociali vacanti, il Direttivo le assegna fra i propri componenti a maggioranza assoluta oppure a maggioranza dei due terzi dei suoi componenti.
\end{enumerate}
\item Qualora una carica Sociale cessi dalle sue funzioni prima dello scadere del mandato, il Direttivo è convocato, entro tre giorni, per l’elezione dei nuovi incaricati, che rimangono in carica per il tempo rimanente del mandato interno. 
 \item In caso di vacanza di una carica interna spetta al Direttivo procedere all'elezione del sostituto a maggioranza dei due terzi.
